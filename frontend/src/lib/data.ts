...
// Real sample MP4s from Google's public test bucket
const SAMPLE_VIDEOS = {
  ...
  drama: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4",
  scifi: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4",
  ...
  horror: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
  romance: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4",
  animation: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4",
};
...
export const movies: Movie[] = [
  ...
  },
  {
    ...
    title: "Oppenheimer",
    description:
      "The story of American scientist J. Robert Oppenheimer and his role in the development of the atomic bomb during World War II. A stunning portrayal of brilliance, moral ambiguity, and the weight of historical consequence.",
  ...
  },
  {
    ...
    title: "Interstellar",
    description:
      "A team of explorers travel through a wormhole in space in an attempt to ensure humanity's survival. A breathtaking journey through time, space, and the human condition.",
  ...
  },
  {
    ...
    title: "The Godfather",
    description:
      "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son. A timeless saga of power, loyalty, and family.",
  ...
  },
  {
    ...
    videoUrl: SAMPLE_VIDEOS.romance,
    category: "Romance",
    rating: 8.0,
    year: 2016,
    duration: "2h 8m",
